                            ...
                            <div className='header-right-section'>
                                {
                                    this.props.showSearch ? // This prop would be passed from Home.js for enabling Search bar.
                                        <Input className='search' type='search' placeholder='Search...' p={5}
                                               onChange={(e) => this.handleChange(e)} disableUnderline
                                               startAdornment={
                                ...
                                <IconButton id='profile-icon' onClick={this.profileClickHandler}>
                                    <Avatar variant="circle" alt="profile_picture"
                                            style={{border: '2px solid whitesmoke'}} src={ProfilePicture}/>
                                </IconButton>
                                <div>
                                    <Menu open={this.state.openMenu} onClose={this.menuCloseHandler}
                                        ...
                                        <MenuItem
                                            onClick={this.logoutClickHandler}><Typography>Logout</Typography></MenuItem>
                                    </Menu>
                                </div>
                            </div>
                        </Fragment>
